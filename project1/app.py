...
class Gui:
    ...
    btn_1_1_i2_original = Button(root, text="Original", command=e.show_1_2_original)
    btn_1_1_i2_rgb = Button(root, text="RGB", command=e.show_1_2_rgb)
    btn_1_1_i2_rgb_r = Button(root, text="R-Channel", command=e.show_1_2_rgb_r)
    btn_1_1_i2_rgb_g = Button(root, text="G-Channel", command=e.show_1_2_rgb_g)
    btn_1_1_i2_rgb_b = Button(root, text="B-Channel", command=e.show_1_2_rgb_b)
